...
const stats = [
  { name: "Total Jobs", value: "154", icon: TrendingUp, color: "bg-blue-500", trend: "+12%" },
  { name: "Completed", value: "142", icon: CheckCircle2, color: "bg-emerald-500", trend: "+8%" },
  { name: "Earnings", value: "₹45,280", icon: Wallet, color: "bg-primary-light", trend: "+15%" },
  { name: "Rating", value: "4.9", icon: Star, color: "bg-amber-500", trend: "0.1" },
];
      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <button className="flex items-center gap-2 px-5 py-2.5 bg-primary text-white rounded-xl font-bold text-sm hover:bg-primary-dark transition-all shadow-lg shadow-primary/20">
